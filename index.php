...
// ------------------ { Your Config } ------------------ //
$Config = [
    'api_token' => "TOKEN", // توکن خود را اینجا وارد کنید
    'admin' => [000000000, 0000000000, 0000000000], // ایدی عددی ادمین ها را اینجا وارد کنید
    'channel' => "factweb" // ایدی کانال را بدون @ اینجا وارد کنید
];
$Database = [
    'dbname' => "kola_upload", // نام دیتابیس را اینجا وارد کنید
    'username' => "kola_upload", //یوزرنیم دیتابیس را اینجاوارد کنید
    'password' => "r455exdxf5" //پسورد دیتابیس را اینجا وارد کنید
];
